...
3. **LinkedIn post** (semi-formal). Share three lessons learned from deploying AI agents into production workflows at a blockchain gaming company over the past year. 150–200 words.

4. **One-pager intro** (formal). A one-line document title plus the opening two paragraphs of an internal proposal recommending an automated lead-enrichment pipeline. Audience is the exec team. The team currently spends about 6 hours a week manually enriching roughly 2,000 inbound leads a quarter. 100–150 words.

5. **Rewrite** (semi-formal). Make this paragraph sound natural and human:
